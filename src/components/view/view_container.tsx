...
import { getGroupOnlineMembers, IUser, login, logout, myProfile, updateProfile } from '../../hooks/useTim';
            ...
            if (userID) {
                ...
                const onReadyStateUpdate = async ({ name }: any) => {
                    ...
                    if (isSDKReady && loginState) {
                        const me = await myProfile({ userID, nick: userInfo.nick } as IUser);
            ...
            <div className={wrapperStyles}>
                ...
                {isFullOn ? null : (
                    <>
                        ...
                        <GoodsSlide />
                        <Notice />
                        <CommentWrite setMessageFunc={setMessageFunc} />
