...
export const HeartBtn = () => {
    ...
    const handleAddHeart = (e: any) => {
        ...
        const aniBox = document.querySelector('.animation_box');
        const heart = document.createElement('span');

        heart.style.right = 25 * Math.random() + 'px';

        aniBox?.appendChild(heart);
        heart.classList.add('animate-heart-ani');
        setTimeout(() => {
            heart.remove();
            heart.classList.remove('animate-heart-ani');
        }, 2000);
    ...
    return (
        <button onClick={handleAddHeart} className={'btn'} style={{ bottom: '120px' }}>
                ...
                >
                    ...
                    <g>
                        <g id="그룹_2" data-name="그룹 2">
                            <circle id="타원_1" data-name="타원 1" cx="40" cy="40" r="40" fill="white" />
                            <image
                                id="벡터_고급_개체"
                                data-name="벡터 고급 개체"
                                x="20"
